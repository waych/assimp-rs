...
#[repr(i32)]
pub enum Origin {
    Set = autogenerated_assimp_sys::aiOrigin_aiOrigin_SET,
    Cur = autogenerated_assimp_sys::aiOrigin_aiOrigin_CUR,
    End = autogenerated_assimp_sys::aiOrigin_aiOrigin_END,
}
...
impl<T: FileIO, S: File> FileWrapper<T, S> {
    ...
    unsafe extern "C" fn io_open(
        ...
        let ai_file = aiFile {
            ...
            UserData: Box::into_raw(file) as *mut i8,
        };
    ...
    unsafe extern "C" fn io_close(_ai_file_io: *mut aiFileIO, ai_file: *mut aiFile) {
        let ai_file: &mut aiFile = &mut *ai_file;
        // Given that this is close, we are careful to not leak, but instead drop the file when we
        // exit this scope.
        let file = Box::from_raw(ai_file.UserData as *mut &mut S);
        file.close();
    }
    unsafe extern "C" fn io_read(
        ...
        let file = Box::leak(Box::from_raw((*ai_file).UserData as *mut &mut dyn File));
    ...
    unsafe extern "C" fn io_seek(ai_file: *mut aiFile, pos: size_t, origin: aiOrigin) -> aiReturn {
        ...
        let origin = match origin {
            autogenerated_assimp_sys::aiOrigin_aiOrigin_SET => Origin::Set,
            autogenerated_assimp_sys::aiOrigin_aiOrigin_CUR => Origin::Cur,
            autogenerated_assimp_sys::aiOrigin_aiOrigin_END => Origin::End,
            _ => panic!("Assimp passed invalid origin"),
        };
        match file.seek(pos, origin) {
            Ok(()) => 0,
